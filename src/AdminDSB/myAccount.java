...
public class myAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        status.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel3.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 240, -1));
        ...
        jPanel3.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 240, 30));
        ...
        jPanel3.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 240, 30));
        ...
        jPanel3.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, 240, 30));
        ...
        jPanel3.add(contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 240, 30));
        ...
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 90, 30));
        ...
        jPanel3.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 390, 120, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-admin-64.png"))); // NOI18N
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 110, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (updateChecker()) {
                ...
                new DBConnector().updateData("update john set email = '" + email.getText() + "',username = '" + username.getText() + "', "
