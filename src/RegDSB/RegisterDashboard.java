...
public class RegisterDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(showPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 410, -1, -1));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 290, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-register-64.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (duplicateChecker()) {
                ...
                new DBConnector().insertData("insert into john (email,username,password,contact,type,status) "
    ...
    private boolean duplicateChecker() throws SQLException {
        ResultSet rs = new DBConnector().getData("select * from john where email = '" + email.getText() + "' or username = '" + username.getText() + "'");
