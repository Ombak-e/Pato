...
public class editAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 240, -1));
        ...
        jPanel3.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 240, -1));
        ...
        jPanel3.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 240, 30));
        ...
        jPanel3.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 240, 30));
        ...
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 90, 30));
    ...
    private boolean updateChecker() throws SQLException {
        ResultSet rs = new DBConnector().getData("select * from john where (username = '" + username.getText() + "' or email = '" + email.getText() + "') and id != '" + id.getText() + "'");
        if (rs.next()) {
