...
//    ALTER TABLE accounts_table AUTO_INCREMENT = 1000 or 1;
    ...
    private void initComponents() {
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 265, 29));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 460, 77, -1));
        ...
        jPanel1.add(showPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 320, -1, -1));
        ...
        jPanel1.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 270, 265, 30));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, 85, -1));

        jButton4.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 400, 90, 30));

        jLabel1.setFont(new java.awt.Font("Yu Gothic", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("LOGIN FORM");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 180, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-login-64.png"))); // NOI18N
    ...
    private boolean loginDB(String email, String pass) throws SQLException {
        ResultSet rs = new DBConnector().getData("select * from john where email = '" + email + "' and password = '" + pass + "'");
        if (rs.next()) {
