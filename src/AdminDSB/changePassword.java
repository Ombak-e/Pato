...
public class changePassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 390, 100, -1));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 100, -1));
        ...
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, 90, 30));
        ...
        jPanel3.add(newPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 240, 30));
        ...
        jPanel3.add(showPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-password-64.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (!validationChecker()) {
                ...
                ResultSet rs = new DBConnector().getData("select * from john where id = '" + cons.getId() + "'");
                ...
                if (rs.next()) {
                    ...
                    if (oldPass.equals(oldHash)) {
                        ...
                        new DBConnector().updateData("update john set password = '" + newPass + "' where id = '" + cons.getId() + "'");
