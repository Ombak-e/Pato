...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("CEMENTERY ADMIN DASHBOARD");
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 20, 110, -1));

        jButton7.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel2.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 110, 30));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 20, 110, -1));

        jButton5.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel2.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 60, 110, -1));

        jButton8.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel2.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 60, 110, -1));

        jButton9.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        ...
        jPanel2.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 20, 110, -1));

        id.setEditable(false);
        id.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        id.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        id.setText("ID");
        jPanel2.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 40, 80, 30));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (rowIndex < 0) {
            ...
            try {
                ...
                ResultSet rs = new DBConnector().getData("select * from john where id = '" + tbl.getValueAt(rowIndex, 0) + "'");
                if (rs.next()) {
    ...
    private void displayData() {
        try {
            ResultSet rs = new DBConnector().getData("select * from john where status in ('active', 'inactive') and id != '" + id.getText() + "'");
